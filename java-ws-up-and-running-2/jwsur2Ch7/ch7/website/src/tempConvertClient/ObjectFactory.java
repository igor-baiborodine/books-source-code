 ...
 * generated in the tempConvertClient package. 
...
public class ObjectFactory {
    ...
    private final static QName _C2F_QNAME = new QName("http://tempConvert/", "c2f");
    private final static QName _F2CResponse_QNAME = new QName("http://tempConvert/", "f2cResponse");
    private final static QName _C2FResponse_QNAME = new QName("http://tempConvert/", "c2fResponse");
    private final static QName _F2C_QNAME = new QName("http://tempConvert/", "f2c");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: tempConvertClient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempConvert/", name = "c2f")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempConvert/", name = "f2cResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempConvert/", name = "c2fResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempConvert/", name = "f2c")
