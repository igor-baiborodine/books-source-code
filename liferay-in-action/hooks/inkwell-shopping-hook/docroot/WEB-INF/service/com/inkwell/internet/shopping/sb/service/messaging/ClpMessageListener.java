...
package com.inkwell.internet.shopping.sb.service.messaging;

import com.inkwell.internet.shopping.sb.service.ClpSerializer;
...
public class ClpMessageListener implements MessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			ShoppingCategoryImageLocalServiceUtil.clearService();
		}
	}
