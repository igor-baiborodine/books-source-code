 ...
 * generated in the tcClient package. 
...
public class ObjectFactory {
    ...
    private final static QName _C2FResponse_QNAME = new QName("http://tc/", "c2fResponse");
    private final static QName _C2F_QNAME = new QName("http://tc/", "c2f");
    private final static QName _F2CResponse_QNAME = new QName("http://tc/", "f2cResponse");
    private final static QName _F2C_QNAME = new QName("http://tc/", "f2c");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: tcClient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tc/", name = "c2fResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tc/", name = "c2f")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tc/", name = "f2cResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tc/", name = "f2c")
