    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(clientBase64.SkiImageServiceService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = clientBase64.SkiImageServiceService.class.getResource(".");
            url = new URL(baseUrl, "http://localhost:9876/ski?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:9876/ski?wsdl', retrying as a local file");
