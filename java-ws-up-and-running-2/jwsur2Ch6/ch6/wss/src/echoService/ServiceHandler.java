...
public class ServiceHandler implements SOAPHandler<SOAPMessageContext> {
	...
	String config = 
	    "<xwss:SecurityConfiguration xmlns:xwss=\"http://java.sun.com/xml/ns/xwss/config\" dumpMessages=\"true\"><xwss:RequireUsernameToken passwordDigestRequired=\"false\"/></xwss:SecurityConfiguration>";
